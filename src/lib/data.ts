...
export const MENU_CATALOG: MenuItem[] = [
  ...
  { name: '부대찌개', icon: '🍲', w: { clear: 2, hot: 0, rain: 4, cold: 5 }, m: { good: 3, tired: 3, spicy: 3, hearty: 5, light: 0 } },
  { name: '칼국수', icon: '🍜', w: { clear: 3, hot: 1, rain: 5, cold: 4 }, m: { good: 3, tired: 4, spicy: 0, hearty: 3, light: 2 } },
  { name: '불고기', icon: '🍖', w: { clear: 4, hot: 1, rain: 2, cold: 4 }, m: { good: 5, tired: 2, spicy: 0, hearty: 5, light: 1 } },
  { name: '제육볶음', icon: '🥘', w: { clear: 4, hot: 2, rain: 3, cold: 3 }, m: { good: 4, tired: 2, spicy: 4, hearty: 4, light: 1 } },
  { name: '김밥', icon: '🍙', w: { clear: 4, hot: 4, rain: 2, cold: 2 }, m: { good: 2, tired: 3, spicy: 0, hearty: 1, light: 5 } },
  { name: '우동', icon: '🍜', w: { clear: 2, hot: 0, rain: 4, cold: 4 }, m: { good: 2, tired: 4, spicy: 0, hearty: 2, light: 3 } },
  { name: '라멘', icon: '🍜', w: { clear: 3, hot: 1, rain: 3, cold: 4 }, m: { good: 4, tired: 3, spicy: 2, hearty: 3, light: 1 } },
  { name: '냉모밀', icon: '🍜', w: { clear: 3, hot: 5, rain: 0, cold: 0 }, m: { good: 3, tired: 2, spicy: 0, hearty: 0, light: 5 } },
  { name: '회덮밥', icon: '🐟', w: { clear: 4, hot: 4, rain: 1, cold: 1 }, m: { good: 4, tired: 2, spicy: 1, hearty: 1, light: 4 } },
  { name: '순두부찌개', icon: '🍲', w: { clear: 3, hot: 1, rain: 4, cold: 4 }, m: { good: 3, tired: 4, spicy: 2, hearty: 2, light: 3 } },
  { name: '감자탕', icon: '🍖', w: { clear: 2, hot: 0, rain: 3, cold: 5 }, m: { good: 3, tired: 4, spicy: 2, hearty: 5, light: 0 } },
  { name: '닭갈비', icon: '🍗', w: { clear: 3, hot: 1, rain: 3, cold: 4 }, m: { good: 4, tired: 2, spicy: 4, hearty: 4, light: 0 } },
  { name: '보쌈', icon: '🥩', w: { clear: 3, hot: 1, rain: 2, cold: 4 }, m: { good: 4, tired: 2, spicy: 0, hearty: 5, light: 0 } },
  { name: '훈제오리', icon: '🍗', w: { clear: 3, hot: 2, rain: 2, cold: 3 }, m: { good: 4, tired: 2, spicy: 0, hearty: 4, light: 1 } },
  { name: '타코', icon: '🌮', w: { clear: 4, hot: 4, rain: 1, cold: 1 }, m: { good: 4, tired: 2, spicy: 3, hearty: 2, light: 3 } },
  { name: '햄버거', icon: '🍔', w: { clear: 4, hot: 3, rain: 2, cold: 2 }, m: { good: 3, tired: 3, spicy: 1, hearty: 4, light: 1 } },
  { name: '피자', icon: '🍕', w: { clear: 4, hot: 2, rain: 3, cold: 3 }, m: { good: 5, tired: 2, spicy: 0, hearty: 4, light: 0 } },
  { name: '카레', icon: '🍛', w: { clear: 3, hot: 2, rain: 3, cold: 3 }, m: { good: 3, tired: 3, spicy: 2, hearty: 3, light: 2 } },
  { name: '월남쌈', icon: '🥬', w: { clear: 4, hot: 5, rain: 1, cold: 0 }, m: { good: 3, tired: 2, spicy: 1, hearty: 1, light: 5 } },
  { name: '백반', icon: '🍚', w: { clear: 3, hot: 2, rain: 3, cold: 3 }, m: { good: 3, tired: 4, spicy: 1, hearty: 3, light: 2 } },
]
